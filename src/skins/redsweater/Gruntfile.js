  ...
  grunt.initConfig({
    less: {
      modern: {
        ...
        expand: true,
        rename: function () {
          return "dist/redsweater/skin.min.css";
        },
        src: ["src/main/less/Skin.less"],
        dest: "dist/redsweater"
      },
      ...
      content: {
        ...
        expand: true,
        rename: function () {
          return "dist/redsweater/content.min.css";
        },
      ...
      "content-inline": {
        ...
        expand: true,
        rename: function () {
          return "dist/redsweater/content.inline.min.css";
        },
