...
var PluginManager_1 = require("tinymce/core/api/PluginManager");
var Tools_1 = require("tinymce/core/api/util/Tools");
PluginManager_1["default"].add('redsweater', function (editor) {
    ...
    editor.on("SetContent", function ( /* unused event */) {
        ...
        Tools_1["default"].each(editor.dom.select('blockquote'), function (thisBlockquote) {
            ...
            Tools_1["default"].each(thisBlockquote.childNodes, function (thisChildNode) {
